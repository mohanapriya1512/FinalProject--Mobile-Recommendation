...
# Load sentiment data
sentiment_data = pd.read_csv("C:/Users/ramme/OneDrive/Desktop/DataScience_Priya/Projects_Priya/Mobile_Recommendation/Flipkart_mobile_reviews_Textblob_sentiment.csv")
